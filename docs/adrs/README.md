# Architectural Decision Records (ADRs) - Kanarii

Este directorio contiene el registro de las decisiones de diseño arquitectónico de Kanarii. Seguimos el formato ADR estándar para documentar decisiones técnicas críticas, su contexto y sus consecuencias a largo plazo.

## Índice de ADRs

| ID | Título | Estado | Fecha |
|---|---|---|---|
| [ADR-001](ADR-001-anti-vendor-lockin.md) | Anti vendor lock-in para IA y memoria colectiva | Accepted | 2026-05-22 |
| [ADR-002](ADR-002-firestore-como-backend-principal.md) | Firestore como backend principal en MVP multi-comunidad | Accepted | 2026-05-22 |
| [ADR-003](ADR-003-separacion-rol-global-comunitario.md) | Separación de Rol Global y Rol Comunitario | Accepted | 2026-05-22 |
| [ADR-004](ADR-004-fuente-verdad-membresias-coleccion-plana.md) | Colección Plana community_members como Fuente de Verdad para Membresías | Accepted | 2026-05-22 |
