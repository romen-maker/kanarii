...
| T-117 | Instalar y configurar `i18next` + `react-i18next`, proveedor global, detección y persistencia de idioma en `localStorage` | M | ⬜ Pendiente | — |
| T-118 | Crear selector ES/EN accesible en cabecera/menú y aplicar el atributo `lang` dinámico al documento HTML | S | ⬜ Pendiente | — |
