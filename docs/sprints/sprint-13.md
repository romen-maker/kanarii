...
| T-058 | Notificaciones de menciones en Tablón — Opción A: campo `menciones[]` en post + listener en Sidebar para badge | M | ✅ Completado | `.agents/tasks/_archived/task-058.md` |
