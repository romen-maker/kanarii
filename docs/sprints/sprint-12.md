...
| T-052 | Pasaporte Comunitario completo: OG tags dinámicos, flujo "Conectar" real, widget Kin Maya en PasaporteVisual | L | ✅ Completado | `.agents/tasks/_archived/task-052.md` |
| T-053 | Fix botón "Cancelar" en CreateTareaModal deshabilitado offline | S | ✅ Completado | `.agents/tasks/_archived/task-053.md` |
| T-054 | Conectar vía Tablón con mención pre-rellenada | S | ✅ Completado | `.agents/tasks/_archived/task-054.md` |
