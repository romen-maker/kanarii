...
| T-130 | Internacionalización de componentes interactivos de animación pedagógica del tour | M | ✅ Completada | `.agents/tasks/_archived/task-130.md` |
| T-131 | Internacionalización de FichaView y catálogo Kin determinista | M | ✅ Completada | `.agents/tasks/_archived/task-131.md` |
