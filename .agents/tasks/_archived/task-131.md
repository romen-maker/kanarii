...
- [x] Inyección de `useTranslation('passport')` en `FichaView.tsx`.
- [x] UI fija traducida al 100% en ES/EN sin modificar lógica de fechas ni escrituras Firestore.
- [x] Kin Maya expuesto usando índices numéricos e i18n (`selloIndex`, `tonoIndex`, `colorIndex`).
- [x] `docs/idea-inbox/2026-08-17-centralizar-formato-fechas-civiles-e-instantes.md` registrado.
- [x] Verificaciones `check-i18n-keys`, `check-i18n-visible-literals`, `tsc`, `build` y `lint` superadas.
- [x] Cierre e integración en main completados.
