...
2. **[PRIORIDAD DE IMPLEMENTACIÓN]**: Sigue estrictamente esta jerarquía:
    - 1. **Reutilizar**: `npm install [package]` (Si cumple licencia/calidad).
...
## Ejemplos
- ✅ **Correcto**: "Usuario pide validación de emails. Invoco `tech-scout`. Encuentro `validator`. Lo instalo."
